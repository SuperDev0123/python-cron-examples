                ...
                for k in range(booking_line["e_qty"]):
                    ...
                    tbl_data1 = [
                        [
                            ...
                            Paragraph(
                                "<font size=%s>%s</font>"
                                % (label_settings["font_size_small"], "CARRIER"),
                                style_center,
                            ),
                            Paragraph(
                            ...
                            Paragraph(
                                ...
                                % (label_settings["font_size_medium"], "SYD"),
                                style_center,
                            ),
                            Paragraph(
                    ...
                    tbl_data1 = [
                        [
                            Paragraph(
                                "<font size=%s><b>CONNOTE #</b> %s</font>"
                                % (
                                    label_settings["font_size_small"],
                        ...
                        [
                            Paragraph(
                                "<font size=%s><b>Not Before:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%s</b></font> "
                                % (
                                    label_settings["font_size_extra_small"],
                        ...
                        [
                            Paragraph(
                                "<font size=%s><b>Not After:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%s</b></font> "
                                % (
                                    label_settings["font_size_extra_small"],
                                    booking[
                                        "s_06_LatestDeliveryDateTimeFinal"
                                    ].strftime("%d/%m/%y %H:%M")
                                    if booking["s_06_LatestDeliveryDateTimeFinal"]
                                    else "N/A",
                                ),
                                style_left,
                            )
                        ...
                        [
                            Paragraph(
                                "<font size=%s color=%s><b>Visual Aid Banner</b></font>"
                                % (label_settings["font_size_small"], colors.white),
                                style_center,
                            )
                        ],
                    ]
                    ...
                    tbl_data = [
                        [
                            Paragraph(
                                "<font size=%s><b>DG's<br/> %s<br/></b></font>"
                                % (
                                    label_settings["font_size_medium"],
                                    "Yes" if booking_line["e_dangerousGoods"] else "No",
                                ),
                                style_center,
                            ),
                            Paragraph(
                                "<font size=%s><b>ADP<br/></b></font>"
                                % (label_settings["font_size_large"]),
                                style_center,
                            ),
                            Paragraph(
                                "<font size=%s><b>Signature<br/> Required<br/></b></font>"
                                % (label_settings["font_size_small"]),
                                style_center,
                            ),
                            Paragraph(
                            ...
                            Paragraph(
                                "<font size=%s><b>Item<br/> %s</b></font>"
                                % (
                                    label_settings["font_size_extra_small"],
                                    str(j).zfill(2),
                                ),
                            ...
                            Paragraph(
                                "<font size=%s><b>L: %s<br/> W: %s<br/> H: %s </b></font>"
                                % (
                                    label_settings["font_size_extra_small"],
                            ...
                            Paragraph(
                                "<font size=%s color=%s><b>%s</b><br/></font>"
                                % (
                                    label_settings["font_size_small"],
                                    colors.white,
                    ...
                    t2 = Table(
                        tbl_data,
                        colWidths=(
                            (float(label_settings["label_image_size_length"]) * (1 / 7))
                            * mm
                        ),
                        style=[
                    ...
                    tbl_data = [
                        ...
                        [
                            Paragraph(
                                "<font size=%s>%s <b>%s</b></font>"
                                % (
                                    label_settings["font_size_extra_small"],
                                    str(booking["pu_Address_PostalCode"])
                                    if booking["pu_Address_PostalCode"]
                                    else "",
                                    str(booking["pu_Address_Country"])
                                    if booking["pu_Address_Country"]
                                    else "",
                                ),
                                style_left,
                            )
                    ...
                    t1 = Table(
                        tbl_data,
                        colWidths=(
                            (float(label_settings["label_image_size_length"]) * (1 / 2))
                            * mm
                        ),
                        rowHeights=(
                            float(label_settings["line_height_extra_small"]) * mm
                    ...
                    tbl_data = [
                        [
                            Paragraph(
                                "<font size=%s><b>Payee Ac: %s</b></font>"
                                % (
                                    label_settings["font_size_extra_small"],
                        ...
                        [
                            Paragraph(
                                ...
                                % (
                                    label_settings["font_size_extra_small"],
                                    str(booking["pu_Contact_F_L_Name"])
                    ...
                    tbl_data = [
                        [
                            Paragraph(
                                "<font size=%s><b>Description of Goods:</b> %s</font>"
                                % (
                                    label_settings["font_size_extra_small"],
                        ...
                        [
                            Paragraph(
                                "<font size=%s>DECLARATION BY: %s</font>"
                                % (
                                    label_settings["font_size_extra_small"],
                                    str(booking["pu_Address_PostalCode"])
                                    if booking["pu_Address_PostalCode"]
