...
>>>>>>> 0af8aacabeb731a7525942e2561cd0f1f2f8ae86
...
if __name__ == "__main__":
    ...
    try:
        option = get_option(mysqlcon, "auto_close_bsd_orders")
        if int(option["option_value"]) == 0:
            print("#905 - `auto_close_bsd_orders` option is OFF")
        elif option["is_running"]:
            print("#905 - `auto_close_bsd_orders` script is already RUNNING")
        else:
