...
if __name__ == '__main__':
    ...
    for booking in booking_list:
        ...
        try:
            ...
            try:
                status_history_info = data0['consignmentTrackDetails'][0]['consignmentStatuses'][0]
                ...
                if booking['b_status_API'] != new_status:
                    with mysqlcon.cursor() as cursor:
                        ...
                        cursor.execute(sql, 
                                        (booking['pk_booking_id'], booking['b_status_API'],
                                         str(booking['b_status_API']) + " ---> " + str(new_status), new_status,
                                         datetime.datetime.now(), event_time_stamp, recipient_name, 'fp api'))
                        mysqlcon.commit()
